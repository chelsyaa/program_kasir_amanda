...
Route::get('/detail_penjualan/{id}/struk', [PenjualanController::class, 'struk']);
...
Route::get('/detail_penjualan/{id}', [DetailPenjualanController::class,'index']);
Route::get('/detail_penjualan/{id}/tambah', [DetailPenjualanController::class,'create']);
...
Route::get('/transaksi/{id}/tambah', [TransaksiController::class,'create']);
